...
Lokh: vvod = niLaTawa(SkazalPravdu "да" _            \
        "kijetesantakalu лучшее слово в токипоне?"))

    tokiELinja("Чего такое \"" vvod "\"? Никогда в своей жизни не слышал об хуйне такого уровня долбоеба блять")
    awen("1500")
    tawa(Lokh)
...
SkazalPravdu:
    ...
    awen("1500" tokiELinja(                     \
        "Вы выбрали "                           \
        niLaTawa(Lokh "продолжить" "остановить" \
